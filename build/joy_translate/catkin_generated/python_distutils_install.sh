...
<<<<<<< HEAD
echo_and_run cd "/home/agcommand/vt_agBOT/src/joy_translate"

# ensure that Python install destination exists
echo_and_run mkdir -p "$DESTDIR/home/agcommand/vt_agBOT/install/lib/python2.7/dist-packages"
=======
echo_and_run cd "/home/senoa95/vt_agBOT/src/joy_translate"
...
<<<<<<< HEAD
    ...
    build --build-base "/home/agcommand/vt_agBOT/build/joy_translate" \
    install \
    $DESTDIR_ARG \
...
=======
    ...
    build --build-base "/home/senoa95/vt_agBOT/build/joy_translate" \
    install \
    $DESTDIR_ARG \

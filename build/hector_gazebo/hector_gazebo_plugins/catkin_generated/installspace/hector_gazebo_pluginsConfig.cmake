...
<<<<<<< HEAD
      message(FATAL_ERROR "Project 'hector_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/agcommand/vt_agBOT/install/${idir}'.  ${_report}")
=======
      message(FATAL_ERROR "Project 'hector_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/senoa95/vt_agBOT/install/${idir}'.  ${_report}")
>>>>>>> origin/sena
    endif()

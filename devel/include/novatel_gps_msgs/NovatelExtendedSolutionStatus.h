...
struct NovatelExtendedSolutionStatus_
{
  ...
  _advance_rtk_verified_type advance_rtk_verified;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _psuedorange_iono_correction_type;
...
// {'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'novatel_gps_msgs': ['/home/senoa95/vt_agBOT/src/gps/src/novatel_gps_driver/novatel_gps_msgs/msg']}
...
struct Printer< ::novatel_gps_msgs::NovatelExtendedSolutionStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::novatel_gps_msgs::NovatelExtendedSolutionStatus_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.psuedorange_iono_correction);
  }
};

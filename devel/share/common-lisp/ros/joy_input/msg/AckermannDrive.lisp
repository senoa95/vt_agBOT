...
(cl:defmethod cl:initialize-instance :after ((m <AckermannDrive>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AckermannDrive)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name joy_input-msg:<AckermannDrive> is deprecated: use joy_input-msg:AckermannDrive instead.")))

(cl:ensure-generic-function 'steering_angle-val :lambda-list '(m))
(cl:defmethod steering_angle-val ((m <AckermannDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joy_input-msg:steering_angle-val is deprecated.  Use joy_input-msg:steering_angle instead.")
  (steering_angle m))
...
(cl:defmethod steering_angle_velocity-val ((m <AckermannDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joy_input-msg:steering_angle_velocity-val is deprecated.  Use joy_input-msg:steering_angle_velocity instead.")
  (steering_angle_velocity m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <AckermannDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joy_input-msg:speed-val is deprecated.  Use joy_input-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <AckermannDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joy_input-msg:acceleration-val is deprecated.  Use joy_input-msg:acceleration instead.")
  (acceleration m))

(cl:ensure-generic-function 'jerk-val :lambda-list '(m))
(cl:defmethod jerk-val ((m <AckermannDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joy_input-msg:jerk-val is deprecated.  Use joy_input-msg:jerk instead.")
  (jerk m))

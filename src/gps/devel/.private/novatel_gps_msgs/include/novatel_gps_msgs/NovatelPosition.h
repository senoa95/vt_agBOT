...
struct NovatelPosition_
{
  ...
  _undulation_type undulation;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _datum_id_type;
...
struct Printer< ::novatel_gps_msgs::NovatelPosition_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::novatel_gps_msgs::NovatelPosition_<ContainerAllocator>& v)
  {
    ...
    s << indent << "datum_id: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.datum_id);
    s << indent << "lat_sigma: ";
